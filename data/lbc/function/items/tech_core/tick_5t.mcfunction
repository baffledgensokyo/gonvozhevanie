execute if entity @s[tag=wire] unless block ~ ~ ~ #good_copper run function lbc:items/tech_core/break_ropes
execute if entity @s[tag=furnace] unless block ~ ~ ~ #furnaces run function lbc:items/tech_core/break_ropes
