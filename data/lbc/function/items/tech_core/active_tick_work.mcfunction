...
execute as @e[type=marker,tag=lightning_rod,distance=..100,tag=currentpart] at @s if entity @e[type=lightning_bolt,distance=..0.5] run scoreboard players add tmp lbc.math 5
