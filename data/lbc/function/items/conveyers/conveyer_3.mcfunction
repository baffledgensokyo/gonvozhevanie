...
execute if block ~ ~-.5 ~ magenta_glazed_terracotta[facing=north] as @a[distance=..0.5] at @s run function lbc:items/conveyers/conveyer_3_player_1
execute if block ~ ~-.5 ~ magenta_glazed_terracotta[facing=south] as @a[distance=..0.5] at @s run function lbc:items/conveyers/conveyer_3_player_2
execute if block ~ ~-.5 ~ magenta_glazed_terracotta[facing=west] as @a[distance=..0.5] at @s run function lbc:items/conveyers/conveyer_3_player_3
execute if block ~ ~-.5 ~ magenta_glazed_terracotta[facing=east] as @a[distance=..0.5] at @s run function lbc:items/conveyers/conveyer_3_player_4