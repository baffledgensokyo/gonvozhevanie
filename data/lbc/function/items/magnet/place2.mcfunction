...
execute if score *temp lbc.math matches 1 positioned ~ ~.2 ~ summon item_display run data merge entity @s {item:{},transformation:{scale:[0.8,0.8,0.8]},Tags:["block_overlay","new","magnet_interaction","5_tick_raycast","magnet","active"],brightness:{block:15,sky:15},Rotation:[0.0f,0.0f],item_display:"ground"}
execute if score *temp lbc.math matches 1 run setblock ~ ~ ~ skeleton_skull
