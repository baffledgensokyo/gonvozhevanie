...
execute unless data block ~ ~ ~ Items[] run function lbc:items/hopper_enhancer/all_to_hopper_from_9_slot_container
...
execute if score i1 lbc.math matches ..8 run function lbc:items/hopper_enhancer/tick_5t_yes_9_slot_container_to_hopper_rec_2 with storage lbc.math