...
execute unless data block ~ ~ ~ Items[] run function lbc:items/hopper_enhancer/all_to_hopper_from_chest
...
execute if score i1 lbc.math matches ..26 run function lbc:items/hopper_enhancer/tick_5t_yes_chest_to_hopper_rec_2 with storage lbc.math