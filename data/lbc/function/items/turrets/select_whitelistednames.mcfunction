...
$execute if block ~ ~ ~ chest{Items:[{Slot:$(i)b,components:{"minecraft:custom_name":"\"_\""}}]} as @e[type=#mobs,type=!player,distance=..30] unless data entity @s CustomName run tag @s remove blacklisted
