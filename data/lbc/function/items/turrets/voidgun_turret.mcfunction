...
execute if entity @e[type=#mobs,distance=..120,tag=!blacklisted] facing entity @e[type=#mobs,distance=..120,tag=!blacklisted,limit=1,sort=nearest] eyes positioned ^ ^ ^1 run function lbc:items/turrets/voidgun_turret_shoot
tag @e[type=#mobs,distance=..120] remove blacklisted
