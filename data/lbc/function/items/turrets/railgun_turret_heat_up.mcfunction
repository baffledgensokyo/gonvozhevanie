...
execute if entity @e[type=#mobs,distance=..120,tag=!blacklisted] facing entity @e[type=#mobs,distance=..120,tag=!blacklisted,limit=1,sort=nearest] eyes positioned ^ ^ ^1.4 run function lbc:items/turrets/railgun_turret_heat_up_2
