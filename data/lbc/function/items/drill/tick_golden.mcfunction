...
execute if score if lbc.math matches 1..2 unless items entity @s weapon.mainhand *[minecraft:damage=76] anchored eyes positioned ^ ^ ^ run function lbc:items/drill/tick_golden_loop
