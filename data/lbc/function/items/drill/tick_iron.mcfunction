...
execute if score if lbc.math matches 1..3 unless items entity @s weapon.mainhand *[minecraft:damage=356] anchored eyes positioned ^ ^ ^ run function lbc:items/drill/tick_iron_loop
