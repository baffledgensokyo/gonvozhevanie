...
execute if score tmp lbc.math matches 5.. run scoreboard players set if lbc.math 1
execute if items entity @s container.* redstone_block if score tmp lbc.math matches ..5 run scoreboard players set if lbc.math 2
...
execute if score if lbc.math matches 1..3 unless items entity @s weapon.mainhand *[minecraft:damage=1800] anchored eyes positioned ^ ^ ^ run function lbc:items/drill/tick_hell_loop
