...
execute store result score mot1 lbc.math run data get entity @e[type=minecraft:marker,tag=reycaster,limit=1] Pos[1] 30000
...
execute unless block ~ ~1 ~ #minecraft:airs run scoreboard players set @s y -5000
execute unless block ~ ~2 ~ #minecraft:airs run scoreboard players set @s y -5000
execute unless block ~ ~3 ~ #minecraft:airs run scoreboard players set @s y -5000
execute unless block ~ ~4 ~ #minecraft:airs run scoreboard players set @s y -5000
execute unless block ~ ~5 ~ #minecraft:airs run scoreboard players set @s y -5000
